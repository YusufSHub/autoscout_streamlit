...
KM = st.sidebar.number_input("KM:",min_value=0, max_value=500000, step=10000)
Age = st.sidebar.number_input("Age:",min_value=0, max_value=5)
Hp = st.sidebar.number_input("Hp:",min_value=55, max_value=390)
...
<h1 style="color:white;text-align:center;">Lets predict the price of your car!! </h1>
</div><br>"""
